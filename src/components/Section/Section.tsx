...
const Section = () => {
  return (
    <section className=" flex w-full h-full bg-[#fff] border-2 gap-7 pl-6 pt-4 pb-5">
      <div className="flex flex-col w-[790px]">
        <div className="w-full h-[500px] boder-2 rounded-2xl shadow-[5px_15px_20px_5px_rgba(150,150,150,0.1)]"></div>
        <div className="flex items-center relative mt-10 w-full h-[100px] rounded-xl border-solid border-2 border-[rgb(28, 29, 34, 0.06)]">
        ...
        <div className="mt-5 w-full h-[100px] rounded-xl border-solid border-2 border-[rgb(28, 29, 34, 0.06)]">
      ...
      <div className="pl-6 w-[440px] h-full rounded-xl border-solid border-2 border-[rgb(28, 29, 34, 0.08)]">
